...
import { getFile, getRank } from "@sharedUtils/boardUtils";
import { fetchMoveIsValid } from "@gameplay/common/utils/moveService";
import {
	isPawnPromotion,
	isPawnCapture,
} from "@gameplay/common/utils/moveTypeDetection";
...
function preparePawnPromotion(structuredFEN: ParsedFEN, moveInfo: MoveInfo) {
	const updatedStructuredFEN: ParsedFEN = structuredClone(structuredFEN);
