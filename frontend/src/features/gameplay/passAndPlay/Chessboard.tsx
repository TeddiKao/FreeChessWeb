...
import { clearSquaresStyling, getSquareExists } from "@sharedUtils/boardUtils";
...
interface ChessboardProps extends BaseChessboardProps {
    ...
    setPreviousDraggedSquare: StateSetterFunction<
        OptionalValue<ChessboardSquareIndex>
    >;
    previousDroppedSquare: OptionalValue<ChessboardSquareIndex>;
    setPreviousDroppedSquare: StateSetterFunction<
        OptionalValue<ChessboardSquareIndex>
    >;
}
...
function Chessboard({
    ...
    async function handleOnDrop() {
        ...
        const updatedStructuredFEN = await processMove(parsedFEN, moveInfo);
        ...
        await checkForGameEnd(
            updatedStructuredFEN,
            getOppositeColor(pieceColorToValidate)
        );
    ...
    async function checkForGameEnd(
    ...
    async function handleClickToMove() {
        ...
        const boardPlacement: BoardPlacement = parsedFEN["board_placement"];
    ...
    return (
        <>
            ...
            <ChessboardGrid
                ...
                boardPlacement={parsedFEN["board_placement"]}
