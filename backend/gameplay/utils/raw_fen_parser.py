...
def parse_raw_fen(structured_fen):
    ...
    white_king_square = structured_board_placement.get(str(white_king_starting_square))
    black_king_square = structured_board_placement.get(str(black_king_starting_square))
    
    is_white_king_on_starting_square = white_king_square and white_king_square["piece_type"].lower() == "king" and white_king_square["piece_color"].lower() == "white"
    is_black_king_on_starting_square = black_king_square and black_king_square["piece_type"].lower() == "king" and black_king_square["piece_color"].lower() == "black"
